...
protected:
    void SetUp() override {
        // Common setup code for Logger tests
        // Initialize any required objects or state
    }
    
    void TearDown() override {
        // Common cleanup code for Logger tests
...
TEST_F(LoggerTest, DefaultConstruction) {
...
TEST_F(LoggerTest, BasicOperations) {
...
TEST_F(LoggerTest, BoundaryConditions) {
