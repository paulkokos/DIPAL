...
protected:
    void SetUp() override {
        // Common setup code for ImageFactory tests
        // Initialize any required objects or state
    }
    
    void TearDown() override {
        // Common cleanup code for ImageFactory tests
...
TEST_F(ImageFactoryTest, DefaultConstruction) {
...
TEST_F(ImageFactoryTest, BasicOperations) {
...
TEST_F(ImageFactoryTest, ErrorHandling) {
...
TEST_F(ImageFactoryTest, BoundaryConditions) {
...
TEST_F(ImageFactoryTest, BasicPerformance) {
