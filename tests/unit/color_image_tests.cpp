...
protected:
    void SetUp() override {
        // Common setup code for ColorImage tests
        // Initialize any required objects or state
    }
    
    void TearDown() override {
        // Common cleanup code for ColorImage tests
...
TEST_F(ColorImageTest, DefaultConstruction) {
...
TEST_F(ColorImageTest, BasicOperations) {
...
TEST_F(ColorImageTest, ErrorHandling) {
...
TEST_F(ColorImageTest, BoundaryConditions) {
