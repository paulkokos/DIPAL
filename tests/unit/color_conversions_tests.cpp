...
protected:
    void SetUp() override {
        // Common setup code for ColorConversions tests
        // Initialize any required objects or state
    }
    
    void TearDown() override {
        // Common cleanup code for ColorConversions tests
...
TEST_F(ColorConversionsTest, DefaultConstruction) {
...
TEST_F(ColorConversionsTest, BasicOperations) {
...
TEST_F(ColorConversionsTest, ErrorHandling) {
...
TEST_F(ColorConversionsTest, BoundaryConditions) {
