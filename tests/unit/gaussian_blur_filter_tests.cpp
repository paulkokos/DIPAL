...
protected:
    void SetUp() override {
        // Common setup code for GaussianBlurFilter tests
        // Initialize any required objects or state
    }
    
    void TearDown() override {
        // Common cleanup code for GaussianBlurFilter tests
...
TEST_F(GaussianBlurFilterTest, DefaultConstruction) {
...
TEST_F(GaussianBlurFilterTest, BasicOperations) {
...
TEST_F(GaussianBlurFilterTest, ErrorHandling) {
...
TEST_F(GaussianBlurFilterTest, BoundaryConditions) {
