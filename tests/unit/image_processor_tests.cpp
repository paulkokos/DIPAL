...
protected:
    void SetUp() override {
        // Common setup code for ImageProcessor tests
        // Initialize any required objects or state
    }
    
    void TearDown() override {
        // Common cleanup code for ImageProcessor tests
...
TEST_F(ImageProcessorTest, BasicOperations) {
...
TEST_F(ImageProcessorTest, BoundaryConditions) {
