...
/**
 * @brief Test fixture for BMPImageIO
 */
class BMPImageIOTest : public ::testing::Test {
protected:
    void SetUp() override {
        // Common setup code for BMPImageIO tests
        // Initialize any required objects or state
    }
    
    void TearDown() override {
        // Common cleanup code for BMPImageIO tests
...
TEST_F(BMPImageIOTest, DefaultConstruction) {
...
TEST_F(BMPImageIOTest, BasicOperations) {
...
TEST_F(BMPImageIOTest, ErrorHandling) {
...
TEST_F(BMPImageIOTest, BoundaryConditions) {
...
TEST_F(BMPImageIOTest, BasicPerformance) {
...
TEST_F(BMPImageIOTest, Integration) {
