...
enum class EventType { ProcessingStarted, ProcessingCompleted, ProgressUpdated, Error };
...
public:
    ...
    void onProcessingCompleted(const std::string_view operationName, bool success) override;
    void onProgressUpdated(float progress) override;
    void onError(const std::string_view errorMessage) override;
