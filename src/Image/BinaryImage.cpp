...
BinaryImage::BinaryImage(int width, int height) : Image(width, height, Type::Binary) {
...
Result<std::unique_ptr<BinaryImage>> BinaryImage::fromGrayscale(const GrayscaleImage& image,
                                                                uint8_t threshold,
                                                                bool invert) {
    try {
